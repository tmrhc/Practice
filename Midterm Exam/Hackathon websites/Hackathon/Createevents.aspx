<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Createevents.aspx.cs" Inherits="Createevents" %>
...
<label for= "eventaddress" > Event Address : </label>
            <asp:TextBox ID="txteventaddress" runat="server"></asp:TextBox>
<label for= "eventdetails" > Event Details : </label>
            <asp:TextBox ID="txteventdetails" runat="server" TextMode="MultiLine"></asp:TextBox>

            <asp:button ID="btnaddevent" runat="server" Text="Add Event" OnClick="btnaddevent_Click" />

            <asp:Label ID="lblSuccess1" runat="server" style="font-size: large; font-family: 'Engravers MT'"></asp:Label>
